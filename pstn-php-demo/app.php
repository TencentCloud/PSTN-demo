...
$url="https://test.pstn.avc.qcloud.com";  //请填写分配的host域名，只需要填写http://host这部分

$src="008612345678911"; //主叫用户

$dst="008612345678912";//被叫用户
...
try {
	...
	$callId="12-190123-7f1020da3bf94e19b324a222222222d";//回拨请求响应中返回的 callId
	$cancelFlag="";
...
try {
	...
	$assignVirtualNum="008617080219000";
	$record="1";
